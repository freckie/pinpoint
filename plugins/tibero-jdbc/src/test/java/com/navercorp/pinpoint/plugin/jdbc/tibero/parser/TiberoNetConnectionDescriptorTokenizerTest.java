 ...
 * @author emeroad
 */
public class TiberoNetConnectionDescriptorTokenizerTest {
    ...
    private void assertTrimLeft(String token, String result) {
        TiberoNetConnectionDescriptorTokenizer tokenizer = new TiberoNetConnectionDescriptorTokenizer(token);
    ...
    private void assertCompareToken(String token, String... parsedTokens) {
        ...
        while (true) {
            ...
            if (t == TiberoNetConnectionDescriptorTokenizer.TOKEN_EOF_OBJECT) {
                return;
            }
