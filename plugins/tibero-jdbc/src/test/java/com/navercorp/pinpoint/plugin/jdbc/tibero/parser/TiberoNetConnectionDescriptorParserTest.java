 ...
 * @author emeroad
 */
public class TiberoNetConnectionDescriptorParserTest {
    ...
    public void simple() {
        ...
        TiberoNetConnectionDescriptorParser parser = new TiberoNetConnectionDescriptorParser(rac);
    ...
    public void emptyValue() {
        String rac = "jdbc:tibero:thin:@(DESCRIPTION=(LOAD_BALANCE=)"
    ...
    @Test
    public void parse2() {
        String rac = "jdbc:tibero:thin:@(DESCRIPTION=(LOAD_BALANCE = off )" +
                "(ADDRESS  =  ( PROTOCOL = TCP)(HOST = 1.2.3.4 ) (PORT = 1521 ))" +
                "(ADDRESS = (PROTOCOL = TCP ) (HOST = 1.2.3.5) ( PORT = 1522 ))" +
                " ( CONNECT_DATA = ( SERVICE_NAME = service ) ) )";
...
//                " ( CONNECT_DATA = ( SID = sid ) ) )";
        ...
        TiberoNetConnectionDescriptorParser parser = new TiberoNetConnectionDescriptorParser(rac);
        Assertions.assertThrowsExactly(TiberoConnectionStringException.class, () -> {
            parser.parse();
        });
    }
