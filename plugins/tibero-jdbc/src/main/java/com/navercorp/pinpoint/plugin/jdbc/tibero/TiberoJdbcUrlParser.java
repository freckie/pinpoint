...
import com.navercorp.pinpoint.plugin.jdbc.tibero.parser.DatabaseSpec;
import com.navercorp.pinpoint.plugin.jdbc.tibero.parser.Description;
import com.navercorp.pinpoint.plugin.jdbc.tibero.parser.DescriptionList;
import com.navercorp.pinpoint.plugin.jdbc.tibero.parser.KeyValue;
import com.navercorp.pinpoint.plugin.jdbc.tibero.parser.TiberoNetConnectionDescriptorParser;
import com.navercorp.pinpoint.plugin.jdbc.tibero.parser.ParserUtils;
...
public class TiberoJdbcUrlParser implements JdbcUrlParserV2 {
    ...
    private static final String URL_PREFIX = "jdbc:tibero:"; //jdbc:tibero:thin:@${HOST}:${PORT}:${DB}
