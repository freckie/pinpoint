...
import static com.navercorp.pinpoint.plugin.jdbc.tibero.parser.ParserUtils.compare;
...
public class Description implements DatabaseSpec {
    ...
    private void mapping(KeyValue<?> keyValue) {
        if (!compare(DESCRIPTION, keyValue)) {
            throw new TiberoConnectionStringException(DESCRIPTION  + " node not found");
        }
    ...
    public String getDatabaseId() {
        ...
        return "tiberoDatabaseId not found";
    }
